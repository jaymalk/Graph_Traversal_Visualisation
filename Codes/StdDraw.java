...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static JFrame frame; // CHANGED TO PUBLIC BY RAJBIR MALIK
    ...
    private static void init() {
        ...
        // THE ABOVE LINE WAS MADE A COMMENT BY RAJBIR MALIK. INSTEAD LINE BELOW WAS ADDED.
        // frame.setJMenuBar(myMenuBar());
        frame.pack();
        frame.requestFocusInWindow();
        //ADDED BY RAJBIR MALIK
    ...
    // FUNCTION ADDED BY RAJBIR MALIK
    // Personalised Menu Bar suited for program
    ...
    //     JMenu menu2 = new JMenu("Stop");
    //     menuBar.add(menu2);
    //     menu2.addActionListener(std);
    //     menu2.setMnemonic(KeyEvent.VK_S);
    //     JMenu menu3 = new JMenu("Exit");
    //     menuBar.add(menu3);
    //     menu3.addActionListener(std);
    //     menu1.setMnemonic(KeyEvent.VK_X);
    //     return menuBar;
    // }
...
*/
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // }
        // THE ABOVE LINES WERE COMMENTED BY RAJBIR MALIK AS THESE ARE NO LONGER NEEDED
    }
